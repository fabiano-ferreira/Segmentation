<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FatorPosicionamentoSegmento.aspx.cs" Inherits="UI.DadosVariaveis.FatorPosicionamentoSegmento" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id="formtitulo"><img src="../Images/div_titulo.gif" align="absmiddle"/>Dados Variáveis | Fator | Posicionamento por Segmento</td>
  </tr>
  <tr>
    <td>
    <table width="99%" align="right" border="0" cellspacing="3" cellpadding="0" id="formfont">
        ...
        <tr>
          <td>
            <asp:DropDownList ID="ddlVersao" runat="server" CssClass="txtbox" Width="95%"></asp:DropDownList></td>
          <td><asp:DropDownList ID="ddCampanha" runat="server" CssClass="txtbox" Width="95%"></asp:DropDownList></td>
          <td><asp:DropDownList ID="ddlModelo" runat="server" CssClass="txtbox" Width="86%"></asp:DropDownList>
              &nbsp;<asp:ImageButton ID="ImageButton3" runat="server" 
                  ImageUrl="~/Images/Icones/pesquisar.gif" />
            </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
  ...
  <tr>
    <td id="botoes"
    	...
    	<div id="botoesform">
	    <ul>
	        <li><asp:LinkButton ID="lkbSalvar" runat="server" ><asp:Image ID="imgSalvar" runat="server" ToolTip="Salvar" ImageAlign="AbsMiddle" ImageUrl="../Images/Icones/salvar.gif"/> 
                Salvar</asp:LinkButton></li>
	        <li class="separator"></li>
	        <li><asp:LinkButton ID="lkbCancelar" runat="server" ><asp:Image ID="imgCancelar" runat="server" ToolTip="Cancelar" ImageAlign="AbsMiddle" ImageUrl="../Images/Icones/cancelar.gif"/> 
...
******************************************************************************** -->        
    <div id="gridform">
        ...
        Width="100%" AllowPaging="false" CellPadding="4">
          ...
          <asp:BoundField HeaderText="Descrição" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="grid_tittle" HeaderStyle-Width="90%">
            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
          </asp:BoundField>
          </Columns>
          <HeaderStyle/>
...
******************************************************************************** -->        
    <div id="gridform">
        <asp:GridView ID="grvFatoresComuns" runat="server" AutoGenerateColumns="False" GridLines="none"
        Width="100%" AllowPaging="false" CellPadding="4">
          <FooterStyle/>
          <RowStyle CssClass="grid_line_01" />
          <Columns>
...
******************************************************************************** --></td>
  ...
  <tr>
    <td><table width="99%" align="right" border="0" cellspacing="3" cellpadding="0" id="formfont">
      ...
      <tr>
        <td width="25%">Fatores Vinculados ao Produto:</td>
        <td width="25%">&nbsp;</td>
        <td width="25%">&nbsp;</td>
        <td width="25%">&nbsp;</td>
      </tr>
      <tr>
        <td><asp:DropDownList ID="ddlFatoresVinculados" runat="server" CssClass="txtbox" Width="95%"></asp:DropDownList></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
...
******************************************************************************** -->        
    <div id="gridform">
        <asp:GridView ID="grvFatoresVinculados" runat="server" AutoGenerateColumns="False" GridLines="none"
        Width="100%" AllowPaging="false" CellPadding="4">
          <FooterStyle/>
          <RowStyle CssClass="grid_line_01"/>
          <Columns>
          ...
          <asp:BoundField HeaderText="Fatores Vinculados ao Produto" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="grid_tittle" HeaderStyle-Width="90%">
            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
          </asp:BoundField>
          </Columns>
          <HeaderStyle/>

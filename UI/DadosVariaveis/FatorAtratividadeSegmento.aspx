<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FatorAtratividadeSegmento.aspx.cs" Inherits="UI.DadoVariavel.FatorAtratividadeSegmento" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id="formtitulo"><img src="../Images/div_titulo.gif" align="absmiddle"/>Dados Variáveis | Fator | Atratividade por Segmento</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    <td id="botoes">
	    ...
	    <ul>
	        ...
	        <li><asp:LinkButton ID="lkbCancelar" runat="server" ><asp:Image ID="imgCancelar" runat="server" ToolTip="Cancelar" ImageAlign="AbsMiddle" ImageUrl="../Images/Icones/cancelar.gif"/> Cancelar</asp:LinkButton></li>
	    </ul>
	    </div>
...
******************************************************************************** -->        
    <div id="gridform">
        ...
        Width="100%" AllowPaging="false" CellPadding="4">
          ...
          <asp:BoundField HeaderText="Nome" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="grid_tittle" HeaderStyle-Width="90%">
            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
          </asp:BoundField>
          </Columns>
          <HeaderStyle/>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SegmentacaoClientesImportados.aspx.cs" Inherits="UI.DadosVariaveis.SegmentacaoClientesImportados" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id="formtitulo"><img src="../Images/div_titulo.gif" align="absmiddle"/>Dados Variáveis | Segmentação de Clientes Importados</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    <td id="botoes">
    	...
    	<div id="botoesform">
	    <ul>
	        <li><asp:LinkButton ID="lkbSegmentarClientes" runat="server" ><asp:Image ID="imgSegmentar" runat="server" ToolTip="Segmentar Clientes" ImageAlign="AbsMiddle" ImageUrl="../Images/Icones/segmentar.gif"/> Segmentar Clientes</asp:LinkButton></li>

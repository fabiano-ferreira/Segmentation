<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CampanhaManutencao.aspx.cs" Inherits="UI.DadosBasicos.Campanha" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id="formtitulo"><img src="../Images/div_titulo.gif" align="absmiddle"/>Dados Básicos | Campanha | Manutenção</td>
  </tr>
  <tr>
    <td>
    <table width="99%" align="right" border="0" cellspacing="3" cellpadding="0" id="formfont">
        ...
        <tr>
          <td width="25%">Nome:<asp:RequiredFieldValidator ID="rfvNome" runat="server" ErrorMessage="*" ControlToValidate="txtNome" ValidationGroup="Cadastro"></asp:RequiredFieldValidator></td>
          <td width="25%">
        ...
        <tr>
          <td><asp:TextBox ID="txtNome" runat="server" CssClass="txtbox" Width="95%" MaxLength="50"/></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
  ...
  <tr>
    <td id="botoes">
    	...
    	<div id="botoesform">
	    <ul>
	        <li><asp:LinkButton ID="lkbSalvar" runat="server" ValidationGroup="Cadastro" 
...
******************************************************************************** -->        
    <div id="gridform">
        ...
        Width="100%" AllowPaging="false" CellPadding="4" DataKeyNames="IDCampanha, Nome">
          <FooterStyle/>
          ...
          <asp:BoundField HeaderText="Código" HeaderStyle-HorizontalAlign="Center" DataField="IDCampanha" HeaderStyle-CssClass="grid_tittle_div" HeaderStyle-Width="10%">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoSegmentoMercado.aspx.cs" Inherits="UI.DadosBasicos.TipoSegmentoMercado" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id="formtitulo"><img src="../Images/div_titulo.gif" align="absmiddle"/>Dados Básicos | Tipo de Segmento de Mercado</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    <td id="botoes">
    	...
    	<div id="botoesform">
	    <ul>
	        <li><asp:LinkButton ID="lkbSalvar" ValidationGroup="Salvar" runat="server" onclick="lkbSalvar_Click" ><asp:Image ID="btnSalvar" runat="server" ToolTip="Salvar" ImageAlign="AbsMiddle" ImageUrl="../Images/Icones/salvar.gif"/> Salvar</asp:LinkButton></li>
...
******************************************************************************** -->    
    <div id="gridform">
        <asp:GridView ID="grvTipoSegmento" runat="server" AutoGenerateColumns="False" GridLines="none" DataKeyNames="IdTipoSegmento, Nome"
        Width="100%" AllowPaging="false" CellPadding="4">
          ...
          <asp:TemplateField ItemStyle-Width="25px" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="grid_tittle">
            <ItemTemplate>
              <asp:ImageButton ID="BtnEdit" OnClick="Edit_Click" runat="server" ImageUrl="~/Images/Icones/editar.gif" ToolTip="Editar"/>
            </ItemTemplate>
          ...
          <asp:BoundField HeaderText="Código" DataField="IDTipoSegmento" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="grid_tittle_div" HeaderStyle-Width="10%">
            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
          </asp:BoundField>
          <asp:BoundField HeaderText="Nome" DataField="Nome" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="grid_tittle" HeaderStyle-Width="90%">
            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
          </asp:BoundField>
          </Columns>
          <HeaderStyle/>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClasseVariavelManutencao.aspx.cs" Inherits="UI.DadosBasicos.ClasseVariavel" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id="formtitulo"><img src="../Images/div_titulo.gif" align="absmiddle"/>Dados Básicos | Classe Variável | Manutenção</td>
  </tr>
  <tr>
    <td>
        ...
        <tr>
          <td width="25%">Codigo:<asp:RequiredFieldValidator ID="rfvCodigo" runat="server" 
                  ControlToValidate="txtCodigo" ErrorMessage="*" SetFocusOnError="True" 
                  ValidationGroup="Salvar"></asp:RequiredFieldValidator></td>
          <td width="25%">Nome:<asp:RequiredFieldValidator ID="rfvNome" runat="server" 
        ...
        <tr>
          <td><asp:TextBox ID="txtCodigo" runat="server" CssClass="txtbox" Width="95%" MaxLength="25"/></td>
          <td><asp:TextBox ID="txtNome" runat="server" CssClass="txtbox" Width="95%" MaxLength="30"/></td>
          <td><asp:TextBox ID="txtIdClasseVariavel" runat="server" style="display:none;"></asp:TextBox></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>Descrição:<asp:RequiredFieldValidator ID="rfvDescricao" runat="server" 
        ...
        <tr>
          <td colspan="2"><asp:TextBox ID="txtDescricao" runat="server" CssClass="txtbox" Width="97.5%" MaxLength="60" Height="20px"/></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
  ...
  <tr>
    <td id="botoes">
    	...
    	<div id="botoesform">
	    <ul>
	        <li><asp:LinkButton ID="lkbSalvar" runat="server" ValidationGroup="Salvar" onclick="lkbSalvar_Click" ><asp:Image ID="btnSalvar" runat="server" ToolTip="Salvar" ImageAlign="AbsMiddle" ImageUrl="../Images/Icones/salvar.gif"/> Salvar</asp:LinkButton></li>
...
******************************************************************************** -->        
    <div id="gridform">
        <asp:GridView ID="grvClasseVariavel" runat="server" AutoGenerateColumns="False" GridLines="none" DataKeyNames="IdClasseVariavel, Nome, Descricao, Codigo"
        Width="100%" AllowPaging="false" CellPadding="4">
          ...
          <asp:TemplateField ItemStyle-Width="25px" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="grid_tittle">
            <ItemTemplate>
              <asp:ImageButton ID="btnEditar" runat="server" ImageUrl="~/Images/Icones/editar.gif" ToolTip="Editar" OnClick="btnEdit_Click"/>
            </ItemTemplate>
          ...
          <asp:BoundField HeaderText="Código" DataField="Codigo" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="grid_tittle_div" HeaderStyle-Width="10%">
            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
          </asp:BoundField>
          <asp:BoundField HeaderText="Nome" DataField="Nome" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="grid_tittle_div" HeaderStyle-Width="45%">
            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
          </asp:BoundField>
          <asp:BoundField HeaderText="Descrição" DataField="Descricao" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="grid_tittle" HeaderStyle-Width="45%">
            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
          </asp:BoundField>          
          </Columns>
          <HeaderStyle/>

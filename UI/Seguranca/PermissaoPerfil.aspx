<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PermissaoPerfil.aspx.cs" Inherits="UI.Seguranca.PermissaoPerfil" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id="formtitulo"><img src="../Images/div_titulo.gif" align="absmiddle"/>Segurança | Perfil | Permissão</td>
  </tr>
  <tr>
    <td>
    <table width="99%" align="right" border="0" cellspacing="3" cellpadding="0" id="formfont">
        ...
        <tr>
          <td><asp:DropDownList ID="ddlUsuario" runat="server" CssClass="txtbox" Width="95%" AutoPostBack="true"
                  onselectedindexchanged="ddlUsuario_SelectedIndexChanged"></asp:DropDownList></td>
          <td>&nbsp;</td>
          <td colspan="2">&nbsp;</td>
        </tr>
        <tr>
          <td colspan="4"><table width="100%" border="0" cellspacing="1" cellpadding="0" id="formfont">
              <tr>
                ...
                <td width="48%">Permissões</td>
              </tr>
              <tr>
                <td>
                <asp:ListBox ID="lbxAssociarPermissoesAdd" runat="server" CssClass="txtbox" Width="98%" SelectionMode="Multiple" Height="120px"></asp:ListBox></td>

...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id="formtitulo"><img src="../Images/div_titulo.gif" align="absmiddle"/>Segurança | Perfil | Manutenção</td>
  </tr>
  <tr>
    <td>
...
******************************************************************************** -->    
    <div id="gridform">
        ...
        Width="100%" AllowPaging="false" CellPadding="4" DataKeyNames="IdPerfil, Nome">
          ...
          <asp:BoundField HeaderText="Código" DataField="IDPerfil" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="grid_tittle_div" HeaderStyle-Width="10%">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfiguracaoGrafico.aspx.cs" Inherits="UI.Relatorios.ConfiguracaoGrafico" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id="formtitulo"><img src="../Images/div_titulo.gif" align="absmiddle"/>Relatórios | Configuração de Gráfico</td>
  </tr>
  <tr>
    <td>
    <table width="99%" align="right" border="0" cellspacing="3" cellpadding="0" id="formfont">
        ...
        <tr>
          ...
          <td><asp:TextBox ID="txtTitulo" runat="server" CssClass="txtbox" Width="85%"/></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
    ...
    <div id="gridform">
        ...
        Width="100%" AllowPaging="false" CellPadding="4">
          ...
          <asp:TemplateField ItemStyle-Width="25px" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="grid_tittle_div">
            <ItemTemplate>
              <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Images/Icones/quadrante.gif" ToolTip="Adicionar Quadrante" />
            </ItemTemplate>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id="formtitulo"><img src="../Images/div_titulo.gif" align="absmiddle"/>Adicionar Quadrante</td>
  </tr>
  <tr>
    <td><table width="99%" align="right" border="0" cellspacing="3" cellpadding="0" id="formfont">
      ...
      <tr>
        <td colspan="2"><asp:TextBox ID="txtQuadrante" runat="server" CssClass="txtbox" Width="84%"/>&nbsp;<asp:ImageButton
                ID="btnAdicionarItem" runat="server" ImageUrl="../Images/Icones/adicionar_item.gif" ToolTip="Adicionar Item" ImageAlign="Middle" /></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MatrizSaida.aspx.cs" Inherits="UI.Relatorios.MatrizSaida" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id="formtitulo"><img src="../Images/div_titulo.gif" align="absmiddle"/>Relatórios | Matriz Saída</td>
  </tr>
  <tr>
    <td>
    <table width="99%" align="right" border="0" cellspacing="3" cellpadding="0" id="formfont">
        ...
        <tr>
          ...
          <td><asp:DropDownList ID="ddlVersao" runat="server" CssClass="txtbox" Width="95%"></asp:DropDownList></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
  ...
  <tr>
   ...
   <!-- **** DESIGN INFORMATION: start botoes form **** -->
    	<div id="botoesform">
	    <ul>
	        <li><asp:LinkButton ID="lkbGerarGrafico" runat="server" ><asp:Image ID="btnGerarGrafico" runat="server" ToolTip="Gerar Gráfico" ImageAlign="AbsMiddle" ImageUrl="../Images/Icones/graficos.gif"/> Gerar Gráfico</asp:LinkButton></li>
